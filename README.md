...
### CHAN Kuen Fai
### CHAN Pak Lam
  Thoughout this experience of working in both github and python coding about path planning, I have gained much experience on how to make code and gain more knowledge on python coding. Making use of the microsoft code to make our own path planning code and visualise the results was extremely extraodinary and thrilling. Github is also another new platform to me which I have never encountered before. The platform shows different kinds of special codes by other contributers. By studying these codes, I think we might learn more coding priciples and how we can make a better and organised code.
