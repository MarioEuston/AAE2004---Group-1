...
### Github
  GitHub is a commercial website and is currently the largest Git Server in the world. Here, a programmer can collaborate with other great programmers, can help contribute   to other people's projects, and others can also give back to his/her projects, creating a virtuous circle. At the same time, it is also the best resume for developers.   It is clear at a glance which projects a programmer has done, which contributions they have made, and which codes they have written. It is difficult and nearly impossible to     counterfeit. In Github, a programmer can also select a location and save their codes and the projects they have done. It will automatically record code changes, and when necessary, can help programmers roll back to the previous historical version. There are many excellent and famous open-source projects shared in Github. Programmers can use and   download these open-source projects for free under the premise of complying with their licenses for many purposes including learning. This is also the most attractive part of GitHub. One of its major     advantages is collaborative development. The projects shared by the programmers can also be improved by other developers which result in improved project functions, fixed bugs and better code quality.
